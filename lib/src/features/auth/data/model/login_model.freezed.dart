...
mixin _$LoginModel {
  ...
  Login? get data => throw _privateConstructorUsedError;
...
abstract class $LoginModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? status, String? message, Login? data});

  $LoginCopyWith<$Res>? get data;
}
...
class _$LoginModelCopyWithImpl<$Res, $Val extends LoginModel>
  ...
  $LoginCopyWith<$Res>? get data {
    ...
    return $LoginCopyWith<$Res>(_value.data!, (value) {
...
class _$_LoginModel implements _LoginModel {
  const _$_LoginModel({this.status, this.message, this.data});
...
abstract class _LoginModel implements LoginModel {
  const factory _LoginModel(
      {final int? status,
      final String? message,
      final Login? data}) = _$_LoginModel;
